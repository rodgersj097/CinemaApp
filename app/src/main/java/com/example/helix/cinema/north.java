...
public class north extends AppCompatActivity {
    ...
    public class getMovies2 extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter adapter = new ArrayAdapter(north.this, android.R.layout.simple_list_item_1 ,movies );
            ListView listView = findViewById(R.id.listViewNorth);
        ...
        protected String doInBackground(String... strings)  {
            ...
            String url = "https://www.cineplex.com/Showtimes/any-movie/cineplex-cinemas-north-barrie?Date=";
